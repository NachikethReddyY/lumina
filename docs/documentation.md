...
The canonical developer setup, commands, and environment variables are described in the root [`README.md`](../README.md). This file focuses on **project overview** and **workflow / phases** so stakeholders can orient quickly without reading every technical detail.
...
**Supporting material in-repo:** [`test-users.md`](test-users.md) (seeded credentials for testing), [`production.md`](production.md) (deployment options and constraints, including low-cost / free-tier paths).
...
- Run frontend lint/build checks as appropriate ([`README.md`](../README.md) scripts).
- Keep **test credentials** and deployment notes current ([`test-users.md`](test-users.md), [`production.md`](production.md)).
...
*For command-level setup and security notes, see [`README.md`](../README.md). For hosting and cost assumptions, see [`production.md`](production.md).*
