...
INSERT INTO users (id, email, password_hash, first_name, last_name, role, status, email_is_verified, name_set, job_title, department, avatar_url, onboarding_completed, approved_by, approved_at, created_at, last_login_at)
VALUES
  ('00000000-0000-0000-0000-000000000028', 'aarav.mehta@lumina.test', crypt('Password1!', gen_salt('bf')), 'Aarav', 'Mehta', 'user', 'active', TRUE, TRUE, 'Business Analyst', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '60 days', NOW() - INTERVAL '2 days'),
  ('00000000-0000-0000-0000-000000000029', 'chloe.nguyen@lumina.test', crypt('Password1!', gen_salt('bf')), 'Chloe', 'Nguyen', 'user', 'active', TRUE, TRUE, 'Operations Specialist', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '58 days', NOW() - INTERVAL '3 days'),
  ('00000000-0000-0000-0000-000000000030', 'ethan.clark@lumina.test', crypt('Password1!', gen_salt('bf')), 'Ethan', 'Clark', 'user', 'active', TRUE, TRUE, 'Support Coordinator', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '56 days', NOW() - INTERVAL '5 days'),
  ('00000000-0000-0000-0000-000000000031', 'mia.rodriguez@lumina.test', crypt('Password1!', gen_salt('bf')), 'Mia', 'Rodriguez', 'user', 'active', TRUE, TRUE, 'Customer Success Manager', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '54 days', NOW() - INTERVAL '7 days'),
  ('00000000-0000-0000-0000-000000000032', 'noah.turner@lumina.test', crypt('Password1!', gen_salt('bf')), 'Noah', 'Turner', 'user', 'active', TRUE, TRUE, 'IT Support Specialist', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '52 days', NOW() - INTERVAL '9 days'),
  ('00000000-0000-0000-0000-000000000033', 'ava.moore@lumina.test', crypt('Password1!', gen_salt('bf')), 'Ava', 'Moore', 'user', 'active', TRUE, TRUE, 'Procurement Analyst', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '50 days', NOW() - INTERVAL '11 days'),
  ('00000000-0000-0000-0000-000000000034', 'liam.singh@lumina.test', crypt('Password1!', gen_salt('bf')), 'Liam', 'Singh', 'user', 'active', TRUE, TRUE, 'Finance Associate', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '48 days', NOW() - INTERVAL '13 days'),
  ('00000000-0000-0000-0000-000000000035', 'isabella.flores@lumina.test', crypt('Password1!', gen_salt('bf')), 'Isabella', 'Flores', 'user', 'active', TRUE, TRUE, 'Marketing Specialist', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '46 days', NOW() - INTERVAL '15 days'),
  ('00000000-0000-0000-0000-000000000036', 'jack.wright@lumina.test', crypt('Password1!', gen_salt('bf')), 'Jack', 'Wright', 'user', 'active', TRUE, TRUE, 'Sales Operations Analyst', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '44 days', NOW() - INTERVAL '17 days'),
  ('00000000-0000-0000-0000-000000000037', 'amelia.hill@lumina.test', crypt('Password1!', gen_salt('bf')), 'Amelia', 'Hill', 'user', 'active', TRUE, TRUE, 'People Operations Coordinator', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '42 days', NOW() - INTERVAL '19 days'),
  ('00000000-0000-0000-0000-000000000038', 'henry.scott@lumina.test', crypt('Password1!', gen_salt('bf')), 'Henry', 'Scott', 'user', 'active', TRUE, TRUE, 'Data Analyst', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '40 days', NOW() - INTERVAL '21 days'),
  ('00000000-0000-0000-0000-000000000039', 'harper.green@lumina.test', crypt('Password1!', gen_salt('bf')), 'Harper', 'Green', 'user', 'active', TRUE, TRUE, 'Legal Operations Associate', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '38 days', NOW() - INTERVAL '23 days'),
  ('00000000-0000-0000-0000-000000000040', 'daniel.baker@lumina.test', crypt('Password1!', gen_salt('bf')), 'Daniel', 'Baker', 'user', 'active', TRUE, TRUE, 'Facilities Coordinator', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '36 days', NOW() - INTERVAL '25 days'),
  ('00000000-0000-0000-0000-000000000041', 'ella.rivera@lumina.test', crypt('Password1!', gen_salt('bf')), 'Ella', 'Rivera', 'user', 'active', TRUE, TRUE, 'Executive Assistant', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '34 days', NOW() - INTERVAL '27 days'),
  ('00000000-0000-0000-0000-000000000042', 'mason.cooper@lumina.test', crypt('Password1!', gen_salt('bf')), 'Mason', 'Cooper', 'user', 'active', TRUE, TRUE, 'Revenue Operations Analyst', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '32 days', NOW() - INTERVAL '29 days'),
  ('00000000-0000-0000-0000-000000000043', 'luna.edwards@lumina.test', crypt('Password1!', gen_salt('bf')), 'Luna', 'Edwards', 'user', 'active', TRUE, TRUE, 'Office Administrator', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '30 days', NOW() - INTERVAL '31 days'),
  ('00000000-0000-0000-0000-000000000044', 'logan.collins@lumina.test', crypt('Password1!', gen_salt('bf')), 'Logan', 'Collins', 'user', 'active', TRUE, TRUE, 'Business Operations Associate', NULL, NULL, TRUE, '00000000-0000-0000-0000-000000000010', NOW() - INTERVAL '28 days', NOW() - INTERVAL '33 days')
ON CONFLICT DO NOTHING;
